          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.sortType"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
...
import BulletinAdd from './NotesAdd.vue'
import BulletinEdit from './NotesEdit.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/user-notes/' + ids).then(() => {
